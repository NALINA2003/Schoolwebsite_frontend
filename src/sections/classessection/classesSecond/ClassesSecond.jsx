...
import container from './ClassesSecond.module.css'
    ...
    <div className={container.first}>
        <div className={container.wrapper}>
          ...
          <div className={container.grid}>
            ...
            {show && (
            <button  onClick={() => window.scrollTo({ top: 0, behavior: "smooth" })} className={container.button}>Join Now</button>
            )}
            </div>
